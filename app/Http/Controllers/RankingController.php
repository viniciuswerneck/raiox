...
class RankingController extends Controller
{
    public function index(Request $request)
    {
        ...
        $cacheKey = "ranking_results_{$locationType}_{$category}";

        $results = \Illuminate\Support\Facades\Cache::remember($cacheKey, now()->addHours(24), function () use ($category, $locationType) {
            ...
            return $data->sortByDesc(function($item) use ($category) {
